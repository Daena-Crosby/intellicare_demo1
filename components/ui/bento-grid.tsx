...
const BentoCard = ({
  ...
  >
    ...
    {background && (
      <div className="pointer-events-none absolute inset-0 transition-all duration-300 group-hover:scale-105">
        {background}
      </div>
    )}
    {children && <div className="relative z-10 h-full p-6">{children}</div>}
  </div>
)
